...
//		Log.e("MultiStatusResponseHandler", EntityUtils.toString(entity));
		return this.getMultistatus(EntityUtils.toString(entity));
	}
	 ...
	 */
	protected Multistatus getMultistatus(String stream)
			throws IOException
	{
		//return null;
