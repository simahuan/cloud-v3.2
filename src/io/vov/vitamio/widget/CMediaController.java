...
private void initFloatingWindow() {
  ...
  /**
   * 当前View,theParentView {@link as} AnchorView
   * 
   * Set the view that acts as the anchor for the control view. This can for
   * example be a VideoView, or your Activity's main view.
   *
   * @param view The view to which to anchor the controller when it is visible. 视频播放器VideoView
   */
  ...
  public void show(int timeout) {
    if (!mShowing && mAnchor != null && mAnchor.getWindowToken() != null) {
      ...
      if (mFromXml) {
        ...
        setWindowLayoutType();
//        LogCat.e("anchorRect.left = %d,anchorRect.bottom= %d\n",anchorRect.left, anchorRect.bottom);
