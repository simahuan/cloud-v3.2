 ...
 */   
public class CVideoView extends SurfaceView implements CMediaController.MediaPlayerControl {
...
//			LogCat.d("onVideoSizeChanged: (%dx%d)", width, height);
...
//	private int mVideoLayout = VIDEO_LAYOUT_FIT_PARENT;
	...
	private static int LOCK_DELAY_TIME = 3*1000; 
	//点击间隔时间
	...
	private OnErrorListener mErrorListener = new OnErrorListener() {
		public boolean onError(MediaPlayer mp, int framework_err, int impl_err) {
			...
			if (getWindowToken() != null) {
				int message = framework_err == MediaPlayer.MEDIA_ERROR_NOT_VALID_FOR_PROGRESSIVE_PLAYBACK ? getResources().getIdentifier(
						"VideoView_error_text_invalid_progressive_playback", "string", mContext.getPackageName()) : getResources().getIdentifier(
				...
				new AlertDialog.Builder(mContext)
						...
						.setMessage(message)
						.setPositiveButton(getResources().getIdentifier("VideoView_error_button", "string", mContext.getPackageName()),
	...
	public void setVideoLayout(int layout, float aspectRatio) {
		...
		LogCat.d("VIDEO: %dx%dx%f, Surface: %dx%d, LP: %dx%d, Window: %dx%dx%f", mVideoWidth, mVideoHeight, mVideoAspectRatio, mSurfaceWidth, mSurfaceHeight,
	...
	public void setMediaController(CMediaController controller) {
		if (mMediaController != null)
			mMediaController.hide();
	...
	public void setVideoLock(boolean videoLock) {
		this.videoLock = videoLock;
	}
	
	public void setVideoLockObject(ImageButton btnVideoLock){
		this.btnVideoLock = btnVideoLock;
	}
	
	public void hidenVideoLockBtn(){
