...
public class RequestManager {
	 ...
	 * @return
	 */
	public LoadControler get(String url, Object params,RequestListener requestListener, int actionId) {
		return this.request(Method.GET, url, params, null, requestListener, false, TIMEOUT_COUNT, RETRY_TIMES, actionId);
	}

	public LoadControler get(final String url, Object data,Map<String,String>headers, final RequestListener requestListener, int actionId) {
		return this.request(Method.GET, url, data, headers, requestListener, false, TIMEOUT_COUNT, RETRY_TIMES, actionId);
	}
	...
	public LoadControler post(final String url, Object data,Map<String,String>headers, final RequestListener requestListener, int actionId) {
	...
	public LoadControler sendRequest(int method, final String url, Object data, final Map<String, String> headers,
		...
		try {
			Log.e(TAG, "volley "+request.getMethod()+" request.getHeaders() = "+request.getHeaders());
		} catch (AuthFailureError e) {
			e.printStackTrace();
		}
