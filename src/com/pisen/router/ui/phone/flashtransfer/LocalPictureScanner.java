 ...
 */
public class LocalPictureScanner extends LocalResourceScanner<ResourceInfo> {
	...
	public void startScan(final Context ctx) {
		new Thread(new Runnable() {
			...
			public void run() {
				...
				List<ResourceInfo> data = rm.listRecursively(Environment.getExternalStorageDirectory().getAbsolutePath(), FileType.Image);
