...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
		...
		if (doScroll) {
			if (mShowViewWhileRefreshing) {
				...
				switch (mCurrentMode) {
					...
					default:
					case PULL_FROM_START:
						int defaultheadHeight =  getResources().getDimensionPixelSize(R.dimen.header_default_height);
						smoothScrollTo((-getHeaderSize())==0?-defaultheadHeight:-getHeaderSize(), listener);
						break;
				}
			} else {
				smoothScrollTo(0);
	 ...
	 */
	@SuppressWarnings("deprecation")
	public void setFailureLoadBg(int drawable,String str){
//		int height = getMeasuredHeight();
//		int width = getMeasuredWidth();
//		View v = LayoutInflater.from(getContext()).inflate(R.layout.pub_fauseload_page, null);
//		LayoutParams p = new LayoutParams(LayoutParams.MATCH_PARENT, height);
//		v.setLayoutParams(p);
//		TextView txt = (TextView) v.findViewById(R.id.fauseload_txt);
//		ImageView img = (ImageView) v.findViewById(R.id.fauseload_img);
//		txt.setText(str);
...
//        setBackgroundDrawable(new BitmapDrawable(bitmap));
	...
	public void setbackgroundcolor_transparent(){
